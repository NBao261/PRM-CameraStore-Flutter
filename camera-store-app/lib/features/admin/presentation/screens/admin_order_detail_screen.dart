...
class AdminOrderDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final shippingInfo = order['shippingInfo'] as Map? ?? {};
    ...
    return BlocListener<AdminOrderBloc, AdminOrderState>(
      listenWhen: (prev, curr) =>
          ...
          (curr.status == AdminOrderStatus.error && curr.errorMessage != null),
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(
            'Đơn #${(order['_id'] as String? ?? '').substring(0, 8)}',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _InfoRow(
                        label: 'Tạm tính',
                        value: _formatCurrency(order['subtotal'] ?? 0)),
                    _InfoRow(
                        label: 'Phí vận chuyển',
                        value: _formatCurrency(order['shippingFee'] ?? 0)),
                    const Divider(),
                    Row(
                    ...
                    return Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          const SizedBox(width: 10),
                          Text(
                            _getStatusLabel(hist['status'] as String? ?? ''),
                            style: const TextStyle(
